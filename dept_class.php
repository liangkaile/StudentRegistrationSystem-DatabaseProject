...
<div id="content">
  ...
  <div id="content_main">
    ...
    <form action="dept_class.php" method ="get">
   <table><tr><td>
	<p class="form">
...
if($id)
  {
       ...
       */
         $sql= "SELECT course_id,section, time,office_hours,room, name FROM ((GivenBy natural join Courses) join Teachers on GivenBy.employee_id = Teachers.employee_id) WHERE Courses.dept_name = '".$id."'";
